...
int main()
{
	...
	cout << "¬ведите количество чисел дл€ генерации: ";
	...
	cout << "\n\nќценка распределени€ генерируемых чисел\n\n";
...
/* ѕолучить случайное значение */
char getRandomNumber(short numberRandom)
{
	const int N = sizeof(short) * 8 / 4; //сдвиг на 1/4 €чейки
